...
function aplicarTemaAmbiental(temperatura = techState.temp) {
    ...
    const periodoEscuro = hora < 6 || hora >= 18;
    const temaAutomatico = periodoEscuro || temperaturaExtrema ? "dark" : "light";
    const modoTema = localStorage.getItem("climateDashboardThemeMode") || "auto";
    const tema = modoTema === "auto" ? temaAutomatico : modoTema;
